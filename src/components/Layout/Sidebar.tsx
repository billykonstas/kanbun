    ...
    <TooltipProvider>
      ...
      >
        ...
        <div>
          ...
          >
            {isOpen && (
              <span className="text-lg font-semibold text-brown max-h-7 whitespace-nowrap">
                My boards
              </span>
            )}
            {isOpen ? (
              ...
              boards.map((board) => (
                ...
                >
                  {isOpen ? (
                    <li
                      key={board.id}
                      className={`flex gap-2 text-brown p-2 mb-1 hover:bg-pink rounded-lg transition-all duration-300 relative overflow-x-hidden whitespace-nowrap max-h-10 ${
